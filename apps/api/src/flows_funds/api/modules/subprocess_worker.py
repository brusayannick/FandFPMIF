...
Spawned by the host (`SubprocessHost`) with::
    ...
    python -m flows_funds.api.modules.subprocess_worker <socket_path> <module_folder>
...
def _collect_handlers(instance) -> list[dict[str, Any]]:
    ...
    from flows_funds.sdk.decorators import get_event_sub, get_job_spec, get_route_spec
